...
summary: SnapCenterは、プラグイン アプリケーションと統合されるほか、ストレージ システム上でNetAppの数々のテクノロジと統合されます。postgresql クラスタ用プラグインを操作するには、 SnapCenterグラフィカル ユーザー インターフェイスを使用します。 
---
...
[role="lead"]
SnapCenterは、プラグイン アプリケーションと統合されるほか、ストレージ システム上でNetAppの数々のテクノロジと統合されます。Plug-in for PostgreSQLクラスタの操作には、SnapCenterのグラフィカル ユーザ インターフェイスを使用します。
...
+
SnapCenterでは、Plug-in for PostgreSQLクラスタでNetApp Snapshotテクノロジを使用してリソースがバックアップされます。



Plug-in for PostgreSQLを使用すると、次のメリットもあります。
