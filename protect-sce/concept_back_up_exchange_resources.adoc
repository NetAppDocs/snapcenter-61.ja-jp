...
summary: SnapCenter Plug-in for Microsoft Exchange Serverをインストールした環境では、SnapCenterを使用してExchangeリソースをバックアップすることができます。 
---
= バックアップのワークフロー
:allow-uri-read: 
:icons: font
...
image:../media/sce_backup_workflow.gif["ワークフロー エクスチェンジャー サーバー データベースのバックアップ"]
